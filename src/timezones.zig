...
pub const Africa = struct {
    ...
    pub const Cairo = create("Africa/Cairo", 120, .no_dst);
    pub const Casablanca = create("Africa/Casablanca", 60, .no_dst);
    pub const Ceuta = create("Africa/Ceuta", 60, .europe_dst);
...
pub const America = struct {
    pub const Adak = create("America/Adak", -600, .us_dst);
    pub const Anchorage = create("America/Anchorage", -540, .us_dst);
    ...
    pub const Boise = create("America/Boise", -420, .us_dst);
    pub const Buenos_Aires = create("America/Buenos_Aires", -180, .no_dst);
    pub const Cambridge_Bay = create("America/Cambridge_Bay", -420, .us_dst);
    ...
    pub const Chicago = create("America/Chicago", -360, .us_dst);
    ...
    pub const Denver = create("America/Denver", -420, .us_dst);
    pub const Detroit = create("America/Detroit", -300, .us_dst);
    pub const Dominica = create("America/Dominica", -240, .no_dst);
    pub const Edmonton = create("America/Edmonton", -420, .us_dst);
    ...
    pub const Glace_Bay = create("America/Glace_Bay", -240, .us_dst);
    pub const Godthab = create("America/Godthab", -180, .no_dst);
    pub const Goose_Bay = create("America/Goose_Bay", -240, .us_dst);
    pub const Grand_Turk = create("America/Grand_Turk", -300, .us_dst);
    ...
    pub const Halifax = create("America/Halifax", -240, .us_dst);
    pub const Havana = create("America/Havana", -300, .us_dst);
    pub const Hermosillo = create("America/Hermosillo", -420, .no_dst);
    pub const Indiana = struct {
        // FIXME: Name conflict
        pub const Indianapolis_ = create("America/Indiana/Indianapolis", -300, .us_dst);
        pub const Knox = create("America/Indiana/Knox", -360, .us_dst);
        pub const Marengo = create("America/Indiana/Marengo", -300, .us_dst);
        pub const Petersburg = create("America/Indiana/Petersburg", -300, .us_dst);
        pub const Tell_City = create("America/Indiana/Tell_City", -360, .us_dst);
        pub const Vevay = create("America/Indiana/Vevay", -300, .us_dst);
        pub const Vincennes = create("America/Indiana/Vincennes", -300, .us_dst);
        pub const Winamac = create("America/Indiana/Winamac", -300, .us_dst);
    };
    pub const Indianapolis = create("America/Indianapolis", -300, .no_dst);
    pub const Inuvik = create("America/Inuvik", -420, .us_dst);
    pub const Iqaluit = create("America/Iqaluit", -300, .us_dst);
    pub const Jamaica = create("America/Jamaica", -300, .no_dst);
    pub const Jujuy = create("America/Jujuy", -180, .no_dst);
    pub const Juneau = create("America/Juneau", -540, .us_dst);
    pub const Kentucky = struct {
        // FIXME: Name conflict
        pub const Louisville_ = create("America/Kentucky/Louisville", -300, .us_dst);
        pub const Monticello = create("America/Kentucky/Monticello", -300, .us_dst);
    };
    ...
    pub const Los_Angeles = create("America/Los_Angeles", -480, .us_dst);
    ...
    pub const Matamoros = create("America/Matamoros", -360, .us_dst);
    pub const Mazatlan = create("America/Mazatlan", -420, .no_dst);
    pub const Mendoza = create("America/Mendoza", -180, .no_dst);
    pub const Menominee = create("America/Menominee", -360, .us_dst);
    pub const Merida = create("America/Merida", -360, .no_dst);
    pub const Metlakatla = create("America/Metlakatla", -540, .us_dst);
    pub const Mexico_City = create("America/Mexico_City", -360, .no_dst);
    pub const Miquelon = create("America/Miquelon", -180, .us_dst);
    pub const Moncton = create("America/Moncton", -240, .us_dst);
    ...
    pub const Nassau = create("America/Nassau", -300, .us_dst);
    pub const New_York = create("America/New_York", -300, .us_dst);
    pub const Nipigon = create("America/Nipigon", -300, .no_dst);
    pub const Nome = create("America/Nome", -540, .us_dst);
    pub const Noronha = create("America/Noronha", -120, .no_dst);
    pub const North_Dakota = struct {
        pub const Beulah = create("America/North_Dakota/Beulah", -360, .us_dst);
        pub const Center = create("America/North_Dakota/Center", -360, .us_dst);
        pub const New_Salem = create("America/North_Dakota/New_Salem", -360, .us_dst);
    };
    pub const Ojinaga = create("America/Ojinaga", -420, .us_dst);
    ...
    pub const Port_au_Prince = create("America/Port-au-Prince", -300, .us_dst);
    ...
    pub const Punta_Arenas = create("America/Punta_Arenas", -180, .us_dst);
    pub const Rainy_River = create("America/Rainy_River", -360, .no_dst);
    pub const Rankin_Inlet = create("America/Rankin_Inlet", -360, .us_dst);
    pub const Recife = create("America/Recife", -180, .no_dst);
    pub const Regina = create("America/Regina", -360, .no_dst);
    pub const Resolute = create("America/Resolute", -360, .us_dst);
    ...
    pub const Thule = create("America/Thule", -240, .us_dst);
    pub const Thunder_Bay = create("America/Thunder_Bay", -300, .no_dst);
    pub const Tijuana = create("America/Tijuana", -480, .us_dst);
    pub const Toronto = create("America/Toronto", -300, .us_dst);
    pub const Tortola = create("America/Tortola", -240, .no_dst);
    pub const Vancouver = create("America/Vancouver", -480, .us_dst);
    pub const Virgin = create("America/Virgin", -240, .no_dst);
    pub const Whitehorse = create("America/Whitehorse", -480, .no_dst);
    pub const Winnipeg = create("America/Winnipeg", -360, .us_dst);
    pub const Yakutat = create("America/Yakutat", -540, .us_dst);
...
pub const Antarctica = struct {
    ...
    pub const Macquarie = create("Antarctica/Macquarie", 660, .new_zeland_dst);
    pub const Mawson = create("Antarctica/Mawson", 300, .no_dst);
    pub const McMurdo = create("Antarctica/McMurdo", 720, .new_zeland_dst);
    pub const Palmer = create("Antarctica/Palmer", -180, .new_zeland_dst);
    ...
    pub const Troll = create("Antarctica/Troll", 0, .new_zeland_dst);
    pub const Vostok = create("Antarctica/Vostok", 360, .no_dst);
};

pub const Arctic = struct {
    pub const Longyearbyen = create("Arctic/Longyearbyen", 60, .europe_dst);
};
...
pub const Asia = struct {
    ...
    pub const Beirut = create("Asia/Beirut", 120, .europe_dst);
    ...
    pub const Famagusta = create("Asia/Famagusta", 120, .europe_dst);
    ...
    pub const Jerusalem = create("Asia/Jerusalem", 120, .israel_dst);
    ...
    pub const Nicosia = create("Asia/Nicosia", 120, .europe_dst);
    ...
    pub const Tel_Aviv = create("Asia/Tel_Aviv", 120, .no_dst);
...
pub const Atlantic = struct {
    pub const Azores = create("Atlantic/Azores", -60, .europe_dst);
    pub const Bermuda = create("Atlantic/Bermuda", -240, .no_dst); //TODO This is not OK need special dst
    pub const Canary = create("Atlantic/Canary", 0, .europe_dst);
    pub const Cape_Verde = create("Atlantic/Cape_Verde", -60, .no_dst);
    pub const Faeroe = create("Atlantic/Faeroe", 0, .no_dst);
    pub const Faroe = create("Atlantic/Faroe", 0, .europe_dst);
    pub const Jan_Mayen = create("Atlantic/Jan_Mayen", 60, .no_dst);
    pub const Madeira = create("Atlantic/Madeira", 0, .europe_dst);
...
pub const Australia = struct {
    ...
    pub const Adelaide = create("Australia/Adelaide", 570, .australia_dst);
    pub const Brisbane = create("Australia/Brisbane", 600, .no_dst);
    pub const Broken_Hill = create("Australia/Broken_Hill", 570, .australia_dst);
    ...
    pub const Hobart = create("Australia/Hobart", 600, .australia_dst);
    pub const LHI = create("Australia/LHI", 630, .no_dst);
    pub const Lindeman = create("Australia/Lindeman", 600, .no_dst);
    pub const Lord_Howe = create("Australia/Lord_Howe", 630, .lord_howe_dst);
    pub const Melbourne = create("Australia/Melbourne", 600, .australia_dst);
    ...
    pub const Sydney = create("Australia/Sydney", 600, .australia_dst);
...
pub const Chile = struct {
    pub const Continental = create("Chile/Continental", -240, .no_dst);
    pub const EasterIsland = create("Chile/EasterIsland", -360, .no_dst);
};
pub const CST6CDT = create("CST6CDT", -360, .no_dst);
pub const Cuba = create("Cuba", -300, .no_dst);
pub const EET = create("EET", 120, .no_dst);
pub const Egypt = create("Egypt", 120, .no_dst);
...
pub const Europe = struct {
    pub const Amsterdam = create("Europe/Amsterdam", 60, .europe_dst);
    pub const Andorra = create("Europe/Andorra", 60, .europe_dst);
    pub const Astrakhan = create("Europe/Astrakhan", 240, .no_dst);
    pub const Athens = create("Europe/Athens", 120, .europe_dst);
    pub const Belfast = create("Europe/Belfast", 0, .no_dst);
    pub const Belgrade = create("Europe/Belgrade", 60, .europe_dst);
    pub const Berlin = create("Europe/Berlin", 60, .europe_dst);
    pub const Bratislava = create("Europe/Bratislava", 60, .europe_dst);
    pub const Brussels = create("Europe/Brussels", 60, .europe_dst);
    pub const Bucharest = create("Europe/Bucharest", 120, .europe_dst);
    pub const Budapest = create("Europe/Budapest", 60, .europe_dst);
    pub const Busingen = create("Europe/Busingen", 60, .europe_dst);
    pub const Chisinau = create("Europe/Chisinau", 120, .europe_dst);
    pub const Copenhagen = create("Europe/Copenhagen", 60, .europe_dst);
    pub const Dublin = create("Europe/Dublin", 0, .europe_dst);
    pub const Gibraltar = create("Europe/Gibraltar", 60, .europe_dst);
    pub const Guernsey = create("Europe/Guernsey", 0, .europe_dst);
    pub const Helsinki = create("Europe/Helsinki", 120, .europe_dst);
    pub const Isle_of_Man = create("Europe/Isle_of_Man", 0, .europe_dst);
    pub const Istanbul = create("Europe/Istanbul", 180, .no_dst);
    pub const Jersey = create("Europe/Jersey", 0, .europe_dst);
    ...
    pub const Lisbon = create("Europe/Lisbon", 0, .europe_dst);
    pub const Ljubljana = create("Europe/Ljubljana", 60, .europe_dst);
    pub const London = create("Europe/London", 0, .europe_dst);
    pub const Luxembourg = create("Europe/Luxembourg", 60, .europe_dst);
    pub const Madrid = create("Europe/Madrid", 60, .europe_dst);
    pub const Malta = create("Europe/Malta", 60, .europe_dst);
    pub const Mariehamn = create("Europe/Mariehamn", 120, .europe_dst);
    pub const Minsk = create("Europe/Minsk", 180, .no_dst);
    pub const Monaco = create("Europe/Monaco", 60, .europe_dst);
    pub const Moscow = create("Europe/Moscow", 180, .no_dst);
    pub const Oslo = create("Europe/Oslo", 60, .europe_dst);
    pub const Paris = create("Europe/Paris", 60, .europe_dst);
    pub const Podgorica = create("Europe/Podgorica", 60, .europe_dst);
    pub const Prague = create("Europe/Prague", 60, .europe_dst);
    pub const Riga = create("Europe/Riga", 120, .europe_dst);
    pub const Rome = create("Europe/Rome", 60, .europe_dst);
    pub const Samara = create("Europe/Samara", 240, .no_dst);
    pub const San_Marino = create("Europe/San_Marino", 60, .europe_dst);
    pub const Sarajevo = create("Europe/Sarajevo", 60, .europe_dst);
    pub const Saratov = create("Europe/Saratov", 240, .no_dst);
    pub const Simferopol = create("Europe/Simferopol", 180, .no_dst);
    pub const Skopje = create("Europe/Skopje", 60, .europe_dst);
    pub const Sofia = create("Europe/Sofia", 120, .europe_dst);
    pub const Stockholm = create("Europe/Stockholm", 60, .europe_dst);
    pub const Tallinn = create("Europe/Tallinn", 120, .europe_dst);
    pub const Tirane = create("Europe/Tirane", 60, .europe_dst);
    ...
    pub const Vaduz = create("Europe/Vaduz", 60, .europe_dst);
    pub const Vatican = create("Europe/Vatican", 60, .europe_dst);
    pub const Vienna = create("Europe/Vienna", 60, .europe_dst);
    pub const Vilnius = create("Europe/Vilnius", 120, .europe_dst);
    pub const Volgograd = create("Europe/Volgograd", 240, .no_dst);
    pub const Warsaw = create("Europe/Warsaw", 60, .europe_dst);
    pub const Zagreb = create("Europe/Zagreb", 60, .europe_dst);
    pub const Zaporozhye = create("Europe/Zaporozhye", 120, .no_dst);
    pub const Zurich = create("Europe/Zurich", 60, .europe_dst);
};
...
pub const Israel = create("Israel", 120, .no_dst);
...
pub const Pacific = struct {
    ...
    pub const Auckland = create("Pacific/Auckland", 720, .new_zeland_dst);
    pub const Bougainville = create("Pacific/Bougainville", 660, .no_dst);
    pub const Chatham = create("Pacific/Chatham", 765, .new_zeland_dst);
    pub const Chuuk = create("Pacific/Chuuk", 600, .no_dst);
    pub const Easter = create("Pacific/Easter", -360, .no_dst); //TODO This is not OK need special dst
    ...
    pub const Norfolk = create("Pacific/Norfolk", 660, .australia_dst);
...
pub const WET = create("WET", 0, .europe_dst);
